...
export default function HomePage() {
  return (
    <div className="min-h-screen from-blue-50 via-amber-50/30 to-white dark:bg-background!">
      {/* Hero Section - 戳痛区 */}
      <section className="max-w-7xl mx-auto px-4 pt-16 md:pt-24 pb-12 md:pb-16">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
          {/* Text Content */}
          <div className="w-full lg:w-1/2 space-y-6">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-medium leading-tight text-gray-900 dark:text-white">
      ...
      {/* 中间向往区 - 美好变化 */}
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-16 bg-white/50 dark:bg-background">
      ...
      {/* 行动区 - CTA */}
      <section className="w-full py-16 md:py-24 from-amber-50 to-blue-50 dark:bg-background">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
          <div className="space-y-8 md:space-y-12 text-center">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 text-base md:text-lg text-gray-700 dark:text-gray-300">
            ...
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 pt-4">

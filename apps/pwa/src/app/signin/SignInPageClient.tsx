...
import type { DeploymentSurface } from "@/lib/runtimeDeployment";
...
function SignInContent({ deploymentSurface }: SignInContentProps) {
  const {
    phone,
    setPhone,
    otp: phoneOtp,
  ...
  const isPreview = deploymentSurface === "preview";
  const isDevelopment =
...
export function SignInPageClient({
  ...
  return (
    ...
    >
      <SignInContent deploymentSurface={deploymentSurface} />
    </Suspense>
  );
}
